      ...
      <AnimatePresence>
        {!isScrolled && (
          <motion.nav
            ...
            className={`fixed top-0 left-0 right-0 z-50 backdrop-blur-md pt-4 transition-colors duration-300 will-change-[backdrop-filter,transform] ${isHome ? "bg-sky-500/15 dark:bg-transparent" : "bg-brand-navy/50 dark:bg-slate-950/90 shadow-sm"}`}
          >

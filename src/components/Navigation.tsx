      ...
      <AnimatePresence>
        {!isScrolled && (
          <motion.nav
            ...
            className={`fixed top-0 left-0 right-0 z-50 backdrop-blur-xl pt-4 transition-colors duration-300 will-change-[backdrop-filter,transform] border-b border-white/5 ${isHome ? "bg-brand-navy/40 dark:bg-brand-navy/30" : "bg-white/70 dark:bg-slate-950/70 shadow-sm"}`}
          >
